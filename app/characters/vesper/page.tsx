    ...
    const fetchCharacterData = async () => {
      try {
        ...
        const response = await fetch("/api/fetch-doc", {
          ...
          body: JSON.stringify({
            url: "https://docs.google.com/document/d/e/2PACX-1vSebZj8CcMq4eEG9h-OMAwavTX-n8KdgKlcrhuNfYXN2ZGT5ufBGW9-phi4_tTK7SpDjAx7V3m0EqrE/pub",
            name: "Vesper",
            docname: "Vesper - PR2",
          }),
        });
        ...
        const { parseVesperCharacter } = await import("../character-parser");
        const formattedHTML = parseVesperCharacter(data.text);
